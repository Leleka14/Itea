...
app.elements.allSection = document.querySelector('.allSection')
...
const firstGoes = () => {
    if(element.info.currentUser){
        ...
        app.elements.allSection.textContent = `Please Log In to play this game`
        app.elements.allSection.style.cssText = `text-align: center;
                                                font-size: 30px;
                                                font-weight: bold;
                                                color: red;
                                                `
